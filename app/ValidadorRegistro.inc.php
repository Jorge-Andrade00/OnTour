...
class ValidadorRegistro {
    ...
    private function validar_nombre($conexion, $nombre) {
        ...
        {
            return "Nombre de usuario en uso. Por favor, intente nuevamente";
        }
        return "";
    }
    ...
    private function validar_email($conexion, $email) {
        ...
        {
            return "Email en uso. Por favor, prueba con otro email o <a href '#'>Intente recuperar su contraseña</a>";
        }
        return "";
    }
